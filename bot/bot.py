...
class Bot:
    ...
    async def reload_channels(self):
        if TESTING:
            log.error("Cannot reload channels in testing mode")
            return
    ...
    async def connect(self):
        log.info(f"Connecting to irc server as {self.username}")
